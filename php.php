...
<body>
    ...
    <form action="p.php" method="get" >
      <pre>
   <label>date</label> <input type='date' name='date' value="<?php echo $date; ?>">                                                                        <button class="btn btn-primary">Export Excel</button>
  </pre>
...
........................................TORTA...................... -->
 ...
 <?php 
  $stmt3 = $conn->prepare("SELECT * FROM orderr WHERE idname= 1 AND date='$date' ");
  $stmt3->execute();
  $rows = $stmt3->fetchAll(); 
...
.........................................................................GATO -->
 ...
 <?php 
  $stmt3 = $conn->prepare("SELECT * FROM orderr WHERE idname= 2 AND date='$date'");
  $stmt3->execute();
  $rows = $stmt3->fetchAll(); 
...
..................................................................BETYFOUR -->
 ...
 <?php 
  $stmt3 = $conn->prepare("SELECT * FROM orderr WHERE idname= 3 AND date='$date'");
  $stmt3->execute();
  $rows = $stmt3->fetchAll(); 
...
........................................SALIZONE ..............-->
 ...
 <?php 
  $stmt3 = $conn->prepare("SELECT * FROM orderr WHERE idname= 4 AND date='$date'");
  $stmt3->execute();
  $rows = $stmt3->fetchAll(); 
...
........................................CHOCOLAT-->
 ...
 <?php 
  $stmt3 = $conn->prepare("SELECT * FROM orderr WHERE idname= 5 AND date='$date'");
  $stmt3->execute();
  $rows = $stmt3->fetchAll(); 
...
.........................................................................SHARQY -->
 ...
 <?php 
  $stmt3 = $conn->prepare("SELECT * FROM orderr WHERE idname= 6 AND date='$date'");
  $stmt3->execute();
  $rows = $stmt3->fetchAll(); 
 ...
 <?php 
  $stmt3 = $conn->prepare("SELECT * FROM special WHERE date='$date'");
  $stmt3->execute();
  $rows = $stmt3->fetchAll(); 
